                    ...
                    <div class="lg:flex bg-slate-100 rounded-md">
                        ...
                        <div class="flex flex-col justify-between py-6 lg:mx-6">
                            <a href="{{ route('eventShow', $event->id) }}"
                                class="text-xl font-semibold text-white dark:text-gray-300 bg-indigo-400 rounded-md p-2 ">
                                {{ $event->title }}
                            </a>

                            <span
                                class=" text-sm p-1 bg-slate-200 rounded-md">{{ $event->country->name }}</span>
